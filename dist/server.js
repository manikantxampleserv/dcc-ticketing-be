...
const startServer = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (process.env.NODE_ENV === "production") {
            ...
            const productionOrigins = allowedOrigins.filter((origin) => origin.startsWith("https://"));
        ...
        io.on("connection", (socket) => {
            logger_1.default.info(`✅ Client connected: ${socket.id} from ${socket.handshake.address}`);
