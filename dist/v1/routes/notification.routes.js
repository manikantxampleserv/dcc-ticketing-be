...
router.put("/notifications/:id/read", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Mark all as read
router.put("/notifications/user/:userId/read-all", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = parseInt(req.params.userId);
...
router.get("/notifications/settings/:userId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = parseInt(req.params.userId);
...
// });
// Get unread count
router.get("/notifications/user/:userId/unread-count", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = parseInt(req.params.userId);
