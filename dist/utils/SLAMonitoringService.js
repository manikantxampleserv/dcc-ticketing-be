            ...
            for (const sla of ticket.ticket_sla_history) {
                ...
                if (delta <= 0 && sla.status === "Pending") {
                    ...
                    if (!this.sentNotifications.has(key)) {
                        ...
                        this.sendNotification({
                            ticket_id: ticket.id,
                            userId: (_b = (_a = ticket === null || ticket === void 0 ? void 0 : ticket.agents_user) === null || _a === void 0 ? void 0 : _a.manager) === null || _b === void 0 ? void 0 : _b.id,
                            title: `SLA Breached for ticket ${ticket.ticket_number} by Agent ${((_c = ticket === null || ticket === void 0 ? void 0 : ticket.agents_user) === null || _c === void 0 ? void 0 : _c.first_name) +
                                " " +
                                ((_d = ticket === null || ticket === void 0 ? void 0 : ticket.agents_user) === null || _d === void 0 ? void 0 : _d.last_name)}`,
                            message: `The ${sla.sla_type} SLA for ticket ${ticket.ticket_number} has been breached.
Assigned Agent: ${(_e = ticket === null || ticket === void 0 ? void 0 : ticket.agents_user) === null || _e === void 0 ? void 0 : _e.first_name} ${(_f = ticket === null || ticket === void 0 ? void 0 : ticket.agents_user) === null || _f === void 0 ? void 0 : _f.last_name}.
...
`;
    ...
    //   }
    // }
    static pauseTicketSLA(ticketId_1) {
        return __awaiter(this, arguments, void 0, function* (ticketId, reason = "Waiting for customer") {
            const now = new Date();
            const ticket = yield prisma.tickets.findUnique({
                where: { id: ticketId },
                include: { sla_priority: true },
            });
            if (!ticket || ticket.sla_status === "Paused")
                return;
            const usedSeconds = BussinessHoursSLACalculation_1.BusinessHoursSLACalculator.calculateBusinessHoursBetween(ticket.sla_paused_at || (ticket === null || ticket === void 0 ? void 0 : ticket.created_at) || new Date(), // last resume / start
            now, {
            ...
            yield prisma.tickets.update({
                ...
                data: {
                    sla_status: "Paused",
                    sla_taken_time_sec: (ticket.sla_taken_time_sec || 0) + Math.floor(usedSeconds),
                    sla_paused_at: now,
                },
            });
            yield prisma.ticket_comments.create({
    ...
    static resumeTicketSLA(ticketId) {
        return __awaiter(this, void 0, void 0, function* () {
            const now = new Date();
            const ticket = yield prisma.tickets.findUnique({
                where: { id: ticketId },
            ...
            for (const sla of ticket.ticket_sla_history) {
                ...
                if (pr.business_hours_only) {
                    ...
                    const pausedBusinessHours = BussinessHoursSLACalculation_1.BusinessHoursSLACalculator.calculateBusinessHoursBetween(pauseStart, now, {
                        business_start_time: pr.business_start_time,
                        business_end_time: pr.business_end_time,
                        include_weekends: pr.include_weekends,
                    });
